...
async def query_database(  # pylint: disable=too-many-statements
    ...
    async def generate():  # pylint: disable=too-many-locals,too-many-branches,too-many-statements
        ...
        relevancy_status = answer_rel.get("status")
        ...
        if relevancy_status != "On-topic": # pylint: disable=too-many-nested-blocks
            ...
            step = {
                ...
                "final_response": True,
                "message": "Off topic question: " + relevancy_reason,
            }
            logging.info("SQL Fail reason: %s", relevancy_reason)  # nosemgrep
            yield json.dumps(step) + MESSAGE_DELIMITER
            ...
            if memory_tool_task:
                ...
                try:
                    ...
                    logging.warning(
                        "Memory initialization/search failed; continuing without memory: %s",
                        mem_error,
                    )
                    memory_tool = None
